...
public class FirstTest {
    ...
    public void testCheckSearchArticleInBackground()
    {
        ...
        waitForElementPresent(
                By.xpath("//*[contains(@text, 'Java (programming language)')]"),
                "Cannot find article after return from background",
                5
        );
    }
    ...
    @Test
    public void testCheckTitleInArticle()
    {
        waitForElementAndClick(
                By.xpath("//*[contains(@text, 'Search Wikipedia')]"),
                "Cannot find Search Wikipedia input",
        ...
        String article_title_locator = "//*[@resource-id='org.wikipedia:id/view_page_title_text'][@text='Java (programming language)']";
        assertElementPresent(
                By.xpath(article_title_locator),
                "Cannot find title in article " + search_line
    ...
    private void assertElementNotPresent(By by, String error_message)
    {
        ...
        if (amount_of_elements > 0){
            String default_message = "An element '" + by.toString() + "' supposed to e not present";
